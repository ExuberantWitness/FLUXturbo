...
def test_subjective_types_marked_skipped():
    ...
    atoms = [
        Atom(node_id="p1", name="P", type="problem", level="W1_problem"),
        Atom(node_id="b1", name="B", type="bottleneck", level="W1_problem"),
        Atom(node_id="c1", name="C", type="concept", level="W2_direction"),
        Atom(node_id="cn1", name="CN", type="conclusion", level="W4_implementation"),
        Atom(node_id="comp1", name="Comp", type="component", level="W5_code"),
    ]
    report = _verifier().verify(atoms, [])
